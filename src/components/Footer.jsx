        ...
        <div className="grid md:grid-cols-3 gap-8 pb-8 border-b border-white/5">
          ...
          <div>
            <motion.a
              ...
              className="inline-block text-2xl font-display font-bold text-gradient mb-4"
            ...
            <div className="flex gap-3">
              {socialLinks.map((link) => (
                <motion.a
                  ...
                  className="w-10 h-10 rounded-full bg-dark-700/50 flex items-center justify-center text-gray-400 hover:text-neon-cyan hover:bg-neon-cyan/10 border border-white/5 hover:border-neon-cyan/30 transition-all"
